...
RSpec.describe LucidShopify::Charge do
  context 'with defaults' do
    ...
    subject(:charge) { LucidShopify::Charge.new(*attributes.values[0, 2]) }
  ...
  context 'with no trial' do
    ...
    subject(:charge) { LucidShopify::Charge.new(*attributes.values[0, 2], trial_days: nil) }
  ...
  context 'with test' do
    ...
    subject(:charge) { LucidShopify::Charge.new(*attributes.values[0, 2], test: true) }
  ...
  context 'with usage based billing' do
    ...
    subject(:charge) { LucidShopify::Charge.new(*attributes.values[0, 2], **attributes.select { |k| %i(price_cap price_terms).include?(k) }) }
